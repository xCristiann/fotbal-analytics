#!/usr/bin/env node
// 1. Scoate Dubla sansa 1X si X2 (cote mici, cerute la eliminare)
// 2. Foloseste notatia 1/2 (nu Gazde/Oaspeti) peste tot unde identificam echipele
// 3. Adauga o pagina noua "Bilete recomandate" - selecteaza automat cea mai
//    buna piata din fiecare meci si propune bilete gata facute (2, 3, 4 selectii)
...
console.log('lib/poisson.ts si app/tickets/page.tsx create. Continui cu link-ul din pagina principala...');
...
console.log('\\nGata! Acum ruleaza:');
console.log('  git add .');
console.log('  git commit -m "Scoate 1X/X2, notatie 1/2, adauga pagina de bilete recomandate"');
