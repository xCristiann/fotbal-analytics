#!/usr/bin/env node
// Sisteme suplimentare de analiza:
// 1. Medii de goluri specifice per liga (nu constante fixe)
// 2. Forma recenta ponderata (ultimele 5, cu pondere descrescatoare)
// 3. Piata reala de cornere (Peste/Sub, calculata Poisson)
// 4. Penalizare pentru accidentari multiple
...
console.log('\nGata! Acum ruleaza:');
console.log('  git add .');
console.log('  git commit -m "Analiza avansata: medii pe liga, forma ponderata, cornere, accidentari"');
